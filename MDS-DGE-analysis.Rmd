...
plotMA(res_123posvs123neg_unfiltered, main="123pos vs 123neg unfiltered", 
       ylim=c(-5,5))
plotMA(res_123posvsBulk_unfiltered,  main="123pos vs Bulk unfiltered", 
       ylim=c(-5,5))
plotMA(res_123negvsBulk_unfiltered,  main="123neg vs Bulk unfiltered", 
       ylim=c(-5,5))

plotMA(res_123posvs123neg_filtered,  main="123pos vs 123neg filtered", 
       ylim=c(-5,5))
plotMA(res_123posvsBulk_filtered,  main="123pos vs Bulk filtered", 
       ylim=c(-5,5))
plotMA(res_123negvsBulk_filtered,  main="123neg vs Bulk filtered", 
       ylim=c(-5,5))
```
...
mart <- useMart(biomart, dataset, host="www.ensembl.org",
path ="/biomart/martservice", port=80, archive=FALSE, version, verbose = FALSE)
