...
DGE_filter<-right_join(ens2gene,DGE_filter, by="ensembl_gene_id") %>% select(external_gene_name, padj, pvalue,log2FoldChange)
...
```{r, echo=FALSE, warning=FALSE, fig.width= 8, fig.height=4.5, fig.align='center'}
